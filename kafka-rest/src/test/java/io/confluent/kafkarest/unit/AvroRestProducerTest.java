...
public class AvroRestProducerTest {
    ...
    schemaHolder =
        new ProduceRequest<>(
            Collections.singletonList(
                new ProduceRecord<>(mapper.readTree("{}"), mapper.readTree("{}"), null, null)),
            /* keySchema= */ null,
            /* keySchemaId= */ null,
            "invalidValueSchema",
            /* valueSchemaId= */ null);
  ...
  public void testInvalidData() throws Exception {
    schemaHolder =
        new ProduceRequest<>(
            Collections.singletonList(
                new ProduceRecord<>(null, mapper.readTree("\"string\""), null, null)),
            /* keySchema= */ null,
            /* keySchemaId= */ null,
            /* valueSchema= */ "\"int\"",
            /* valueSchemaId= */ null);
  ...
  public void testRepeatedProducer() throws Exception {
    ...
    schemaHolder =
        new ProduceRequest<>(
            Collections.singletonList(
                new ProduceRecord<>(null, mapper.readTree("{\"name\": \"bob\"}"), null, null)),
            /* keySchema= */ null,
            /* keySchemaId= */ null,
            valueSchemaStr,
            /* valueSchemaId= */ null);
